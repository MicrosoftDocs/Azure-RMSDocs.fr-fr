...
Le **client Azure information protection (Classic)** télécharge des étiquettes et des paramètres de stratégie à partir du portail Azure. Pour plus d’informations sur ce client, consultez l' [Azure information protection client : historique de publication des versions et stratégie de support](client-version-release-history.md).

Le **client d’étiquetage unifié Azure information protection** télécharge des étiquettes et des paramètres de stratégie à partir des centres d’administration : Office 365 Centre de sécurité et de conformité, Microsoft 365 Security center et Microsoft 365 Compliance Center. Pour plus d’informations sur ce client, consultez le [Azure information protection client d’étiquetage unifié : informations](unifiedlabelingclient-version-release-history.md)sur la version. 
...
|Composant|Client classique|Client d’étiquetage unifié|
|-------|-----------------------------------|----------------------------------------------------|
|Actions d’étiquetage : manuel, recommandé, automatique| Oui | Oui |
