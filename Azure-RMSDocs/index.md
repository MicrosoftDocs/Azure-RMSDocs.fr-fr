...
<article id="main">
    <section id="hero-content">
      ...
      <h2>Vous trouverez ici tout ce dont vous avez besoin pour déployer et gérer Azure Rights Management (Azure RMS). Après une rapide prise en main, vous pourrez commencer à utiliser Azure RMS pour appliquer la protection des informations aux e-mails, aux documents et autres données sensibles.</h2>
