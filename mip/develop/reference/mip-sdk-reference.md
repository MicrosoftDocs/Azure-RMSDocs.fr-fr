...
[MIP :: AsyncControl, classe](class_mip_asynccontrol.md)  |  Classe utilisée pour annuler l’opération asynchrone.
...
[MIP :: InsufficientBufferError, classe](class_mip_insufficientbuffererror.md)  |  Erreur de mémoire tampon insuffisante.
...
[MIP :: TemplateDescriptor, classe](class_mip_templatedescriptor.md)  | Pas encore documenté.
