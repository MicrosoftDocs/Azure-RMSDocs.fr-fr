...
Après un certain temps, quand les utilisateurs sont à l’aise avec l’étiquetage de leurs documents et e-mails, introduisez des configurations plus avancées. comme :
...
1. **Mettre à jour vos étiquettes pour appliquer la protection**
    ...
    Pour le client d’étiquetage unifié Azure Information Protection, consultez [restreindre l’accès au contenu à l’aide du chiffrement dans les étiquettes de sensibilité](https://docs.microsoft.com/microsoft-365/compliance/encryption-sensitivity-labels).
...
2. **Configurer des applications et des services Office**
    ...
    Configurez les applications et services Office pour les fonctionnalités de gestion des droits relatifs à l’information (IRM) dans Microsoft SharePoint ou Exchange Online. Pour plus d’informations, consultez [configuration d’applications pour Azure Rights Management](configure-applications.md).
...
4. **Classifier et protéger les fichiers existants en bloc**
    ...
    Pour les fichiers sur PC, utilisez les applets de commande PowerShell pour classifier et protéger des fichiers. Pour plus d’informations, consultez les guides d’administration suivants :
    ...
    - Azure Information Protection client d’étiquetage unifié : [utilisation de PowerShell avec le client d’étiquetage unifié Azure information protection](./rms-client/clientv2-admin-guide-powershell.md)
...
Vous êtes maintenant prêt à surveiller la manière dont votre organisation utilise les étiquettes que vous avez configurées et à confirmer que vous protégez les informations sensibles. Pour plus d’informations sur la prise en charge de cette phase de déploiement, consultez les éléments suivants :
...
### <a name="step-3-install-the-azure-information-protection-client-classic-and-configure-applications-and-services-for-rights-management"></a>Étape 3 : installer le client Azure Information Protection (Classic) et configurer des applications et des services pour Rights Management
...
2. Configurer des applications et des services Office
    ...
    Configurez les applications et services Office pour les fonctionnalités de gestion des droits relatifs à l’information (IRM) dans SharePoint ou Exchange Online. Pour plus d’informations, consultez [configuration d’applications pour Azure Rights Management](./configure-applications.md).
...
4. Protéger les fichiers existants en bloc 
    ...
    Vous pouvez utiliser les applets de commande PowerShell pour protéger en bloc plusieurs types de fichiers ou annuler cette protection en bloc. Pour plus d’informations, consultez [utilisation de PowerShell avec le client Azure information protection](./rms-client/client-admin-guide-powershell.md) du Guide de l’administrateur.
