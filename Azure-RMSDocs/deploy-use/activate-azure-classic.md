...
description: "Utilisez ces instructions si vous avez accès au portail Azure. Par exemple, vous avez un abonnement à Enterprise Mobility Suite ou êtes abonné à Azure Rights Management Premium."
author: cabailey
manager: mbaldwin
ms.date: 06/27/2016
ms.topic: article
