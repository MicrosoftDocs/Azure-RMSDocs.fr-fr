...
>
> Vous devez également modifier la variable `$webUrls` (par exemple, **https : \//contoso. SharePoint. com**) et @no__t variable-3 (par exemple, **$reports**).
