...
3. **Le service de découverte Azure Rights Management** : Le client RMS se connecte à **`https://discover.aadrm.com`** , qui invite l’utilisateur à s’authentifier.
    ...
    Exemple :  5c6bb73b-1038-4eec-863d-49bded473437.rms.na.aadrm.com/_wmcs/licensing

    *\<YourTenantURL @ no__t-2* a le format suivant : **{GUID}. RMS. [Region]. aadrm. com**. Vous pouvez trouver cette valeur en identifiant la valeur **RightsManagementServiceId** lorsque vous exécutez l’applet [de commande « obtenir-AipServiceConfiguration »](/powershell/module/aipservice/get-aipserviceconfiguration) .
