...
- Identifier toutes les conditions personnalisées et tous les types d’informations sensibles connus.
    ...
    Le démarrage rapide suivant pour la version client classique du scanneur utilise cette configuration : [Démarrage rapide : Trouver quelles sont vos informations sensibles](quickstart-findsensitiveinfo.md).
