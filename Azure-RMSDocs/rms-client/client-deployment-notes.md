...
|                                                                                    **Pour activer et désactiver le suivi**                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Modifiez la clé de Registre suivante :<br /><br />HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MSIPC<br />REG_DWORD : Trace<br /><br />**Valeur :** 1 pour activer le traçage, 0 pour désactiver le suivi (par défaut)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
3. **Le service de découverte Azure Rights Management** : Le client RMS se connecte à **`https://discover.aadrm.com`** , qui invite l’utilisateur à s’authentifier.
    ...
    *\<Url_votre_client\>*  a le format suivant : **{GUID} .RMS. [Region].aadrm.com**. Vous pouvez trouver cette valeur en identifiant les **RightsManagementServiceId** valeur lorsque vous exécutez le [Get-AipServiceConfiguration](/powershell/module/aipservice/get-aipserviceconfiguration) applet de commande.
...
2.  Dans l’Éditeur du Registre, accédez à l’un des éléments suivants :
    ...
    -   Pour la version 64 bits d’Office sur x64 plateforme : HKLM\SOFTWARE\Microsoft\MSIPC\Servicelocation

    -   Pour la version 32 bits d’Office sur x64 plateforme : HKLM\SOFTWARE\Wow6432Node\Microsoft\MSIPC\Servicelocation
