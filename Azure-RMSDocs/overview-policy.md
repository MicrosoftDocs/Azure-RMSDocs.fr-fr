...
description: Comprendre les étiquettes et paramètres dans une stratégie Azure Information Protection qui est téléchargé vers le client Azure Information Protection.
author: cabailey
ms.author: cabailey
manager: barbkess
ms.date: 04/17/2019
