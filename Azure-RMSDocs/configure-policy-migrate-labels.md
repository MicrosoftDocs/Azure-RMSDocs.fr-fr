...
Avant de sélectionner l’option **copier les stratégies (version préliminaire)** dans le panneau d' **étiquetage Azure information protection-Unified** , tenez compte des points suivants :
