...
|Nom commun : **Transférer** <br /><br />Encodage dans la stratégie : **FORWARD**|Active l'option de transfert de message électronique et d'ajout de destinataires aux lignes **À** et **CC** . Ce droit ne s’applique pas aux documents, mais uniquement aux e-mails.<br /><br />N'autorise pas le redirecteur à accorder des droits à d'autres utilisateurs dans le cadre de l'action de transfert. <br /><br />Remarque : Quand vous envoyez un e-mail à une autre organisation, le client Outlook ou l’application web Outlook du destinataire nécessite le droit **Modifier le contenu, Modifier** (nom commun) en plus de Transférer.|Droits personnalisés Office : Refusés en cas d’utilisation de la stratégie standard **Ne pas transférer**.<br /><br />Nom dans le portail Azure Classic : **Transférer**<br /><br />Nom dans les modèles AD RMS : **Transférer** <br /><br />Constante ou valeur d’API : `IPC_EMAIL_FORWARD L"FORWARD"`|
...
|Nom commun : **Répondre** <br /><br />Encodage dans la stratégie : **REPLY**|Active l’option **Répondre** dans un client de messagerie sans autoriser de modification des lignes **À** ou **Cc**.<br /><br />Remarque : lorsque vous envoyez un e-mail à une autre organisation, le client Outlook ou l’application web Outlook du destinataire requiert le droit **Modifier le contenu, Modifier** (nom commun) en plus de l’option Répondre.|Droits personnalisés Office : Non implémenté.<br /><br />Nom dans le portail Azure Classic : **Répondre**<br /><br />Nom dans les modèles AD RMS : **Répondre** <br /><br />Constante ou valeur d’API : `IPC_EMAIL_REPLY`|
|Nom commun : **Répondre à tous** <br /><br />Encodage dans la stratégie : **REPLYALL**|Active l'option **Répondre à tous** dans un client de messagerie, mais ne permet pas à l'utilisateur d'ajouter des destinataires aux lignes **À** ou **CC** .<br /><br />Remarque : lorsque vous envoyez un e-mail à une autre organisation, le client Outlook ou l’application web Outlook du destinataire requiert le droit **Modifier le contenu, Modifier** (nom commun) en plus de l’option Répondre à tous.|Droits personnalisés Office : Non implémenté.<br /><br />Nom dans le portail Azure Classic : **Répondre à tous**<br /><br />Nom dans les modèles AD RMS : **Répondre à tous** <br /><br />Constante ou valeur d’API : `IPC_EMAIL_REPLYALL L"REPLYALL"`|
...
|---------------------|----------------|---------------------------------|
|Observateur|Portail Azure Classic<br /><br />Application de partage Rights Management pour Windows<br /><br />Client Azure Information Protection pour Windows|Afficher, Ouvrir, Lire ; Répondre ; Répondre à tous<br /><br />Remarque : n’utilisez pas ce niveau d’autorisation pour Répondre ou Répondre à tous lorsque vous envoyez un e-mail à une autre organisation et que le destinataire utilise Outlook ou Outlook Web App. Utilisez plutôt l’option Réviseur, qui inclut le droit **Modifier le contenu, Modifier** (nom commun), dont ces clients de messagerie ont besoin pour répondre.|
