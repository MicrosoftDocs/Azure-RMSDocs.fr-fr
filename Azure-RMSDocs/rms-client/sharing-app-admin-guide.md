...
## <a name="ad-rms-only-support-for-multiple-email-domains-within-your-organization"></a>AD RMS uniquement : Prise en charge de plusieurs domaines de messagerie dans votre organisation
