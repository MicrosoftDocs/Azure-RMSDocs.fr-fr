...
|Aucun droit AD RMS <br><br> Aucune description <br><br> **Points de mise en œuvre courants** : Alt+Impr. écr.|Appelez [IpcProtectWindow](https://msdn.microsoft.com/library/hh535268.aspx) sur toutes les fenêtres qui affichent le contenu de documents.|
