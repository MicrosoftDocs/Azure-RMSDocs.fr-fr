...
1.  Identifiez les ordinateurs (deux au minimum) qui exécuteront
2.  le connecteur RMS. Ils doivent présenter les caractéristiques minimales indiquées dans les conditions préalables.
