...
description: "Utilisez le tableau suivant pour identifier les besoins ou problèmes métier auxquels votre entreprise peut être confrontée, et savoir de quelle façon Azure RMS peut y remédier."
author: cabailey
manager: mbaldwin
ms.date: 07/13/2016
ms.topic: article
