...
4. Extrayez les fichiers et suivez les instructions de **PrepareClient.cmd** pour ajouter le nom du serveur pour votre URL de licence extranet du cluster AD RMS. 
