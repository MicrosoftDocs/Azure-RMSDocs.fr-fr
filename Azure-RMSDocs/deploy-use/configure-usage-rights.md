...
|-------------------------------|---------------------------|-----------------|
|Nom commun : **Modifier le contenu, Modifier** <br /><br />Encodage dans la stratégie : **DOCEDIT**|Permet à l’utilisateur de modifier, réorganiser, mettre en forme ou filtrer le contenu de l’application. N'accorde pas le droit d'enregistrer la copie modifiée.<br /><br />Dans Word, ce droit n’est pas suffisant pour activer ou désactiver le **Suivi des modifications**, ni pour utiliser toutes les fonctionnalités de suivi des modifications en tant que réviseur. Utiliser toutes les options de suivi des modifications requiert le droit suivant : **Contrôle total**. |Droits personnalisés Office : En relation avec les options **Modifier** et **Contrôle total**. <br /><br />Nom dans le portail Azure Classic : **Modifier le contenu**<br /><br />Nom dans le portail Azure : **Modifier le contenu, Modifier (DOCEDIT)**<br /><br />Nom dans les modèles AD RMS : **Modifier** <br /><br />Constante ou valeur d’API : Non applicable|
...
|Nom commun : **Afficher, Ouvrir, Lire** <br /><br />Encodage dans la stratégie : **VIEW**|Permet à l'utilisateur d'ouvrir le document et d'en voir le contenu.<br /><br /> Dans Excel, ce droit n’est pas suffisant pour trier et filtrer des données, ni pour créer des tableaux croisés dynamiques. Ces actions requièrent le droit suivant : **Modifier le contenu, Modifier**. [Plus d’informations](https://cloudblogs.microsoft.com/enterprisemobility/2015/12/09/enabling-document-interaction-sort-filter-etc-while-disabling-saving-with-rms/)|Droits personnalisés Office : Comme l’option **Afficher** de la stratégie personnalisée **Lecture**.<br /><br />Nom dans le portail Azure classique : **Afficher**<br /><br />Nom dans le portail Azure : **Afficher, Ouvrir, Lire (VIEW)**<br /><br />Nom dans les modèles AD RMS : **Répondre à tous** <br /><br />Constante ou valeur d’API : `IPC_GENERIC_READ L"VIEW"`|
