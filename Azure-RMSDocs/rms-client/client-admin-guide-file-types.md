...
- **Pour tous les autres fichiers** :
    ...
    - Pour la version publique du client : 1 Go
    
    - Pour la préversion du client (version minimale **1.8.41.0**) : limitée uniquement par l’espace disque et la mémoire disponibles
