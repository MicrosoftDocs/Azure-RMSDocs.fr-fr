...
Ce script utilise **2.2.0.0** comme version minimale pour le module Protection RMS. Exécutez la commande suivante pour vérifier la version : `(Get-Module RMSProtection -ListAvailable).Version` 
