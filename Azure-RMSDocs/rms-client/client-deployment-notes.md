...
-   HKEY_LOCAL_MACHINE\Software\Microsoft\MSIPC\TrustedServers\
    ...
    **Value :** Si une valeur différente de zéro est spécifiée, le client RMS approuve uniquement les serveurs spécifiés configurés dans la liste TrustedServers et le service Azure Rights Management.
...
1. **Le Registre Windows sur l’ordinateur local** : Si les paramètres de découverte de service sont configurés dans le registre, ces paramètres sont essayés en premier. 
...
2. **Services de domaine Active Directory** : Un ordinateur joint à un domaine interroge Active Directory pour un point de connexion de service (SCP). 
