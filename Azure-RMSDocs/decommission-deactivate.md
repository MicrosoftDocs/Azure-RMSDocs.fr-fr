...
- Pour plus d’informations sur les AD RMS et les références de déploiement, consultez [services AD RMS (Active Directory Rights Management Services) vue d’ensemble](https://technet.microsoft.com/library/hh831364.aspx).
