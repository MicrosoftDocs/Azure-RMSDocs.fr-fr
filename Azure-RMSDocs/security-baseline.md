...
- [Balise de service Azure Information Protection](./requirements.md#service-tags)
...
- [Autorisation du service Azure Rights Management pour BYOK](./byok-price-restrictions.md#authorizing-the-azure-rights-management-service-to-use-your-key)
...
- [Connectez-vous à Azure Information Protection avec Azure Active Directory](./requirements.md)
...
- [Authentification Azure Information Protection via Azure Active Directory](./requirements.md)
...
- [Rôle d’administrateur Azure Information Protection](/azure/active-directory/users-groups-roles/directory-assign-admin-roles#azure-information-protection-administrator)
...
- [Azure Information Protection actions que l’administrateur peut entreprendre](/azure/active-directory/users-groups-roles/directory-assign-admin-roles#azure-information-protection-administrator-permissions)
...
- [Aide sur l’utilisation de PowerShell pour Azure Information Protection](./rms-client/client-admin-guide-powershell.md)
...
- [Droits inclus dans les niveaux d’autorisation pour Azure Information Protection](./configure-usage-rights.md#rights-included-in-permissions-levels)

- [Rights Management émetteur et Rights Management propriétaire](./configure-usage-rights.md#rights-management-issuer-and-rights-management-owner)
...
- [Présentation de la boîte postale](/azure/security/fundamentals/customer-lockbox-overview)
...
- [Vue d’ensemble de Azure Information Protection](./index.yml)

- [Aide sur la configuration du client d’étiquetage unifié](./rms-client/clientv2-user-guide.md)
...
- [Aide sur le suivi et la révocation](./rms-client/client-track-revoke.md)
...
- [Gérer la protection des informations par le biais du centre de sécurité et conformité](/microsoft-365/compliance/protect-information?amp;preserve-view=true&view=o365-worldwide)
...
- [Rapports d’activité d’audit dans Azure AD](/azure/active-directory/reports-monitoring/concept-audit-logs)
...
- [Gérer l’utilisation et les coûts avec les journaux Azure Monitor](/azure/azure-monitor/platform/manage-cost-storage)
...
- [Prise en main des étiquettes de sensibilité dans le centre de conformité et de sécurité](/microsoft-365/compliance/get-started-with-sensitivity-labels?amp;preserve-view=true&view=o365-worldwide)

- [Créer et publier des étiquettes de sensibilité](/microsoft-365/compliance/create-sensitivity-labels?amp;preserve-view=true&view=o365-worldwide)

- [Appliquer le chiffrement aux étiquettes de sensibilité](/microsoft-365/compliance/encryption-sensitivity-labels?amp;preserve-view=true&view=o365-worldwide)

- [PowerShell pour Azure Information Protection](./administer-powershell.md)
...
- [Azure Information Protection Bring Your Own Key et intégration à Azure Key Vault](./byok-price-restrictions.md)
- [Activer la suppression réversible dans Key Vault](/azure/storage/blobs/storage-blob-soft-delete?tabs=azure-portal)
