---
title: SDK et énumérations de référence du kit de développement logiciel MIP pour C++
description: Documentation de référence sur les structs et les enums du kit de développement logiciel (SDK) C++ MIP.
author: msmbaldwin
