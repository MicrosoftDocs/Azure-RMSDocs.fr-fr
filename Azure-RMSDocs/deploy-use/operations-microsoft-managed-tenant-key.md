...
description: "Informations sur les opérations de cycle de vie applicables si Microsoft gère votre clé de locataire pour Azure Rights Management (par défaut)."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
