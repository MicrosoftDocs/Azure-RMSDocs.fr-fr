...
Le SDK MIP (Microsoft Information Protection) pour C++ (préversion) permet aux développeurs de gérer et d’appliquer des stratégies de protection des données à des données et d’autres ressources numériques.  
...
[mip::ConsentResult](class_mip_consentresult.md) | Décrit le résultat de la demande de consentement après interaction de l’utilisateur.
...
[mip::ExecutionState](class_mip_executionstate.md) | Interface pour tous les états nécessaires pour exécuter le moteur.
...
[mip::FileHandler::Observer](class_mip_filehandler_observer.md) | Interface Observer permettant aux clients d’obtenir des notifications pour les événements liés aux gestionnaires de fichiers.
[mip::FileIOError](class_mip_fileioerror.md) | Erreur d’E/S de fichier.
[mip::FileProfile](class_mip_fileprofile.md) | Classe racine pour les opérations Microsoft Information Protection.
[mip::FileProfile::Observer](class_mip_fileprofile_observer.md) | Interface Observer utilisée pour recevoir des notifications d’événements liés aux profils.
...
[mip::JustifyAction](class_mip_justifyaction.md) | La demande nécessite de fournir une justification pour le passage d’une étiquette à une version antérieure et de définir la réponse dans l’état d’exécution.
[mip::Label](class_mip_label.md) | Abstraction d’une étiquette unique Microsoft Information Protection.
[mip::LabelingOptions](class_mip_labelingoptions.md) | Interface pour la configuration d’options de création d’étiquettes pour la méthode SetLabel.
...
[mip::PrivilegedRequiredError](class_mip_privilegedrequirederror.md) | L’étiquette actuelle a été définie par une méthode d’affectation privilégiée et ne peut pas être substituée.
[mip::Profile](class_mip_profile.md) | Classe racine pour les opérations Microsoft Information Protection.
[mip::Profile::Observer](class_mip_profile_observer.md) | Interface utilisée pour recevoir des notifications d’événements liés aux profils.
[mip::Profile::Settings](class_mip_profile_settings.md) | Configure les paramètres de profil.
[mip::ProtectAdhocAction](class_mip_protectadhocaction.md) | Classe d’action qui spécifie l’ajout de protection ad hoc au document.  
...
[mip::ProtectDoNotForwardAction](class_mip_protectdonotforwardaction.md) | Classe d’action qui spécifie l’ajout de protection Ne pas transférer au document.
[mip::ProtectionProfile](class_mip_protectionprofile.md) | Classe de base utilisée pour effectuer des opérations de protection.
[mip::ProtectionProfile::Observer](class_mip_protectionprofile_observer.md) | Utilisée pour recevoir des notifications de profil de protection.
...
[mip::UserPolicy](class_mip_userpolicy.md) | Représente la stratégie associée à du contenu protégé.
