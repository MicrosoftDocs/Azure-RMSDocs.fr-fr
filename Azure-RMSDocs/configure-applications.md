...
> [!IMPORTANT]
> Pour plus d’informations sur les versions prises en charge et les autres exigences, consultez [configuration requise pour Azure Information Protection](requirements.md).
